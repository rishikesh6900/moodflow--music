...
router.get('/:mood', async (req, res) => {
  ...
  try {
    ...
    // 2. Fetch Tracks 
    // Use the tracks generated by Gemini, or fall back to empty array which triggers safety logic
    const aiTracks = intent.tracks || [];
    const tracks = await musicService.fetchTracks(aiTracks);
